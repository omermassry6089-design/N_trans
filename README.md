...
<body>
    ...
    <script>
        ...
        async function translateText() {
            ...
            const apiKey = "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";
                ...
                const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
                    ...
                    body: JSON.stringify({
                        ...
                        messages: [
                            {
                                role: "system",
                                content: "אתה כלי תרגום להודעות ארוכות וחופרות (כמו הודעות שבט ותנועות נוער). המטרה שלך היא לקחת הודעה מלאה במילות מילוי, לחלץ אך ורק את השורה התחתונה, המשימות הנדרשות, זמנים, מקומות ולבוש, ולהציג את זה בצורה הכי קצרה, חדה וישירה שיש (בתבליטים). בלי פתיחות ובלי שטויות."
                            },
                            {
                                role: "user",
                                content: text
